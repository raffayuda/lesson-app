        ...
        <div class="flex items-center gap-2 lg:gap-4">
            ...
            <div class="relative">
                ...
                {#if showDropdown}
                    ...
                    >
                        <div class="p-4 border-b border-gray-100 dark:border-gray-700 bg-gradient-to-br from-gray-50 to-white dark:from-gray-700 dark:to-gray-800">
                            <p
                        ...
                        <div class="p-2">
                            ...
                            >
                                <i class="fas fa-user-edit w-4 text-gray-500 dark:text-gray-400"></i>
